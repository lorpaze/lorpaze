//Дана вещественная матрица A(n,m), n≤10,m≤15. Поменять местами столбец, содержащий максимальное количество отрицательных элементов, и столбец, содержащий максимальное количество положительных элементов. Если таких столбцов несколько – использовать первые найденные. Вывести на консоль исходную матрицу, номера найденных столбцов и найденное количество элементов, а также полученную матрицу.
...
// Вывод номера столбцов с их количеством элементов
